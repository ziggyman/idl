...
;############################
pro fxcor_out_RXJ_plot_mean,list,print
;############################
;
; NAME:                  fxcor_out_RXJ_plot_mean.pro
; PURPOSE:               plots mean values of 'vobs', 'vrel' or 'vhelio' for RXJ for
;                        the 2 ccd-chips (blue, red_l+red_r)
;
; CATEGORY:              spectral analysis
; CALLING SEQUENCE:      fxcor_out_RXJ_plot,'</yoda/UVES/MNLupus/ready/fxcor_dats_blue+red.list>','print'
; INPUTS:                input file: list ('</yoda/UVES/MNLupus/ready/fxcor_dats_blue+red.list>'):
...
; --- plot
    ...
    plot,hjdarrmean,vrelarrmean,psym=2,xtitle='heliocentric julian date (hjd) [day]',ytitle='relative radial velocity with respect to 1st (v_rel) [km/s]',yrange=[vrelmin-1,vrelmax+1],ystyle=1,color=1,title='fxcor_out_RXJ_plot_mean: list='+list
