...
pro plot_spectra_of_five,spectralist,linelist,ranges
;common maxn,dlambda,lambda,flux

;
; NAME:                  plot_spectra_of_five.pro
; PURPOSE:               plots a spectrum and names the lines
; CATEGORY:              data reduction
; CALLING SEQUENCE:      plot_spectra_of_five,spectralist,linelist,ranges
; INPUTS:                spectralist:
;                           spectruma
;                           spectrumb
;                           ...
...
if n_elements(ranges) eq 0 then begin
  ...
  print,'Usage: plot_spectra_of_five,spectralist,linelist,ranges'
  print,"Example: plot_spectra_of_five,'/home/azuri/spectra/joss/000-010.list','/home/azuri/spectra/joss/lines1.list','/home/azuri/spectra/joss/ranges.list'"
  spectralist = '/home/azuri/spectra/joss/text.list'
  linelist = '/home/azuri/spectra/joss/lines_BAF.list'
  ranges = '/home/azuri/spectra/joss/ranges_long.list'
endif; else begin
  ...
  for i=0,i_nranges-1 do begin
    ...
    openw,lunh,str_htmlfile,/GET_LUN
      ...
      while i_ispec lt i_nspec do begin
        ...
        i_ispec_end = i_ispec + 5
        if i_ispec_end lt 100 then $
          str_speclist = str_speclist+'0'
        if i_ispec_end lt 10 then $
          str_speclist = str_speclist+'0'
        str_speclist = str_speclist+strtrim(string(i_ispec_end),2)+'.list'
        ...
        plot_some_spectra,str_speclist,linelist,dblarr_ranges(i,0),dblarr_ranges(i,1),OUTFILE=str_outfile
