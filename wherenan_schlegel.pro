...
;
;      This procedure became somewhat obsolete in IDL V5.2 with the introduction
;      of the /NAN keyword to the FINITE function.     WHERENAN is equivalent
;      to the command      Result = WHERE( FINITE(ARRAY,/NAN) )
;
; CALLING SEQUENCE:
