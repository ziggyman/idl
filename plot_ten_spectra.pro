...
pro plot_ten_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile
;common maxn,dlambda,lambda,flux

;
; NAME:                  plot_ten_spectra.pro
; PURPOSE:               plots a spectrum and names the lines
; CATEGORY:              data reduction
; CALLING SEQUENCE:      plot_ten_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile
; INPUTS:                spectralist:
;                           spectruma
;                           spectrumb
;                           ...
...
if strlen(xmax) eq 0 then begin
  ...
  print,'Usage: plot_ten_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile'
  print,"Example: plot_ten_spectra,'/home/azuri/spectra/joss/000-010.list','/home/azuri/spectra/joss/lines1.list',3930.,3970.,OUTFILE='/home/azuri/spectra/joss/000-010_lines1.ps'"
endif else begin
