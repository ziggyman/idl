...
pro plot_some_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile
;common maxn,dlambda,lambda,flux

;
; NAME:                  plot_some_spectra.pro
; PURPOSE:               plots a spectrum and names the lines
; CATEGORY:              data reduction
; CALLING SEQUENCE:      plot_some_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile
; INPUTS:                spectralist:
;                           spectruma
;                           spectrumb
;                           ...
...
if strlen(xmax) eq 0 then begin
  ...
  print,'Usage: plot_some_spectra,spectralist,linelist,xmin,xmax,OUTFILE=outfile'
  print,"Example: plot_some_spectra,'/home/azuri/spectra/joss/000-010.list','/home/azuri/spectra/joss/lines1.list',3930.,3970.,OUTFILE='/home/azuri/spectra/joss/000-010_lines1.ps'"
endif else begin
...
;      dbl_ymax = max(dblarr_spectra(i,intarr_index_range,1))
      dblarr_temp = dblarr_spectra(i,intarr_index_range,1)
      dbl_mean = dblarr_temp((sort(dblarr_temp))(long(count/2)))
      dbl_ymin = 0.5 * dbl_mean
      dbl_ymax = 1.5 * dbl_mean
    endif
    print,'dbl_mean = ',dbl_mean
