pro rave_compare_feh_to_mh
  ...
  str_indexfile = strmid(str_filename_in,0,strpos(str_filename_in,'/',/REVERSE_SEARCH))+'/mh-from-feh-and-afe/index.html'
;  str_indexfile = strmid(str_filename_in,0,strpos(str_filename_in,'/',/REVERSE_SEARCH))+'/index.html'
...
;                                I_STR_DELIMITER = ';')
    ...
    for i=0,24 do begin
      ...
      b_diff_only = 0
      b_y_vs_x_only = 0
      b_dont_plot_guide_line = 0
      dblarr_xrange = [-1.2,0.5]
      dblarr_yrange = [-1.2,0.5]
      str_xtickformat = '(F4.1)'
      str_plotname_root = strmid(str_filename_in,0,strpos(str_filename_in,'/',/REVERSE_SEARCH))+'/mh-from-feh-and-afe/'
      if i eq 0 then begin;
        str_plotname_root = str_plotname_root + 'aFe_vs_FeH'
        str_xtitle = '[Fe/H]!DS&G!N [dex]'
        str_ytitle = '[!4a!3/Fe]!DS&G!N [dex]'
        dblarr_x = dblarr_feh
        dblarr_y = dblarr_afe
        b_y_vs_x_only = 1
        dblarr_xrange = [-1.5,0.5]
        dblarr_yrange = [0.,0.5]
        b_dont_plot_guide_line = 1
      end else if i eq 1 then begin; --- Zwitter
      ...
      end else if i eq 3 then begin; --- mine
        dblarr_logg = double(strarr_data(*,int_col_logg))
        ...
        str_xtitle = '[Fe/H]!DS&G!N [dex]'
        str_ytitle = '[M/H]!D[Fe/H]!N [dex]'
        diff_str_ytitle = '[Fe/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_feh
        ...
        str_xtitle = '[M/H]!DS&G!N [dex]'
        str_ytitle = '[M/H]!D[Fe/H]!N [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_mh
        dblarr_y = dblarr_mh_calib_new
        dblarr_yrange_diff = [-0.5,0.5]
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean_vs_Teff_calibrated'
        str_xtitle = 'T!Deff!N [K]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_teff
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean_vs_logg_calibrated'
        str_xtitle = 'log g [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_logg
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean-calib_vs_FeH_calibrated'
        str_xtitle = '[Fe/H]!DS&G!N [dex]'
        str_ytitle = '[M/H]!D[Fe/H]!N [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_feh
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean-calib-logg-calib-Teff-calib-FeH_vs_Teff'
        str_xtitle = 'T!Deff!N [K]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_teff
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean-calib-logg-calib-Teff-calib-FeH_vs_logg'
        str_xtitle = 'log g [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_logg
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean-calib-logg-calib-Teff-calib-FeH-calib_vs_logg'
        str_xtitle = 'log g [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_logg
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH_-_MH-from-FeH-smoothed-mean-calib-logg-calib-Teff-calib-FeH-calib_vs_Teff'
        str_xtitle = 'T!Deff!N [K]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_teff
        dblarr_y = dblarr_mh - dblarr_mh_calib_new
        ...
        str_plotname_root = str_plotname_root + 'MH-from-FeH-smoothed-mean-calib-calib_vs_MH-new'
        str_xtitle = '[M/H]!D[Fe/H]!N [dex]'
        str_ytitle = '[M/H]!DS&G!N [dex]'
        diff_str_ytitle = '[M/H]!DS&G!N - [M/H]!D[Fe/H]!N [dex]'
        dblarr_x = dblarr_mh_calib_new
        dblarr_y = dblarr_mh
        dblarr_yrange_diff = [-0.5,0.5]
  ...
  ;                           DBLARR_RAVE_SNR          = dblarr_rave_snr,$
                           ...
                           I_B_Y_VS_X_ONLY                    = b_y_vs_x_only,$; --- dblarr_y given as dblarr_x-<some_parameter>
                           ...
                           I_B_DONT_PLOT_GUIDE_LINE           = b_dont_plot_guide_line
      ...
      if (i eq 5) or (i eq 9) or (i eq 11) or (i eq 16) or (i eq 18) or (i eq 19) or (i eq 20) then begin
        str_calib = strmid(str_plotname_root,0,strpos(str_plotname_root,'/',/REVERSE_SEARCH)+1)
        ...
        if (i eq 5) or (i eq 16) or (i eq 20) then begin
          printf,lun_cal,'#[Fe/H] mean([Fe/H]-[M/H])'
        end else if (i eq 11) or (i eq 19) then begin
          printf,lun_cal,'#log_g mean([Fe/H]-[M/H])'
        end else if (i eq 9) or (i eq 18) then begin
          printf,lun_cal,'#Teff mean([Fe/H]-[M/H])'
        endif
