...
;  load_ebf_halo,file1,"/Rad",halo,"rad"             ;distance
...
;  load_ebf_halo,file1,"/Smass",halo,"mass"          ;star mass
  load_ebf_halo,file1,"/FeH",halo,"feh"             ;metallicty FeH
;  load_ebf_halo,file1,"/Age",halo,"age"             ;age
  load_ebf_halo,file1,"/Teff",halo,"teff"           ;log(Teff)
  load_ebf_halo,file1,"/Grav",halo,"logg"           ;log(g)
  ; --- empty labels
  load_ebf_halo,file1,"/Smass",halo,"r"    ; distance
  load_ebf_halo,file1,"/Smass",halo,"mi"   ; Abs I mag
  load_ebf_halo,file1,"/Smass",halo,"cjk"  ; Color J-K
  load_ebf_halo,file1,"/Smass",halo,"vrad"   ; radial vel
  ...
  halo.vrad=(halo.vx*halo.px+halo.vy*halo.py+halo.vz*halo.pz)/halo.r
end
