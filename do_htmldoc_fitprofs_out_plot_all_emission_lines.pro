...
;############################################
pro do_htmldoc_fitprofs_out_plot_all_emission_lines
;############################################

; ### ALL EMISSION LINES
; --- blue
    psfilelist_blue = '/yoda/UVES/MNLupus/ready/blue/fitprofs_all_emission_lines_to_fit_ranges_blue_sort_out_hjd_vobs.list'
    spawn,'rm '+psfilelist_blue
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/blue/single_wavelength_files_all_emission_lines_blue_*_hjd_vobsmean.eps > '+psfilelist_blue
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/blue/fitprofs_all_emission_lines_to_fit_ranges_blue_sort_out_????.*_hjd_vobs.eps >> '+psfilelist_blue
...
; --- red_r
    psfilelist_r = '/yoda/UVES/MNLupus/ready/red_r/fitprofs_all_emission_lines_to_fit_ranges_r_sort_out_hjd_lambda.list'
    spawn,'rm '+psfilelist_r
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/red_r/single_wavelength_files_all_emission_lines_r_*_hjd_vobsmean.eps > '+psfilelist_r
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/red_r/fitprofs_all_emission_lines_to_fit_ranges_r_sort_out_????.*_hjd_vobs.eps >> '+psfilelist_r
...
; --- red_l
    psfilelist_l = '/yoda/UVES/MNLupus/ready/red_l/fitprofs_all_emission_lines_to_fit_ranges_red_l_sort_out_hjd_lambda.list'
    spawn,'rm '+psfilelist_l
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/red_l/single_wavelength_files_all_emission_lines_l_*_hjd_vobsmean.eps > '+psfilelist_l
    spawn,'ls -1 /yoda/UVES/MNLupus/ready/red_l/fitprofs_all_emission_lines_to_fit_ranges_l_sort_out_????.*_hjd_vobs.eps >> '+psfilelist_l
...
; --- blue
    openw,lunw,'/yoda/UVES/MNLupus/ready/website/vobs/index_all_blue.html',/GET_LUN
    printf,lunw,'<html>'
    printf,lunw,'<head>'
    ...
    printf,lunw,'<center>'
    printf,lunw,'<h1>MNLupus: observed radial velocities for the emission lines with respect to feature positions in first image</h1><br>'
...
; --- red_r
    openw,lunw,'/yoda/UVES/MNLupus/ready/website/vobs/index_all_red_r.html',/GET_LUN
    printf,lunw,'<html>'
    printf,lunw,'<head>'
...
; --- red_l
    openw,lunw,'/yoda/UVES/MNLupus/ready/website/vobs/index_all_red_l.html',/GET_LUN
    printf,lunw,'<html>'
    printf,lunw,'<head>'
