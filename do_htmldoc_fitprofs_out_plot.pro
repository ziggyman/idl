...
;############################################
pro do_htmldoc_fitprofs_out_plot
;############################################

    do_htmldoc_fitprofs_out_plot_all_emission_lines
    do_htmldoc_fitprofs_out_plot_known_emission_lines


    openw,lunw,'/yoda/UVES/MNLupus/ready/website/vobs/index.html',/GET_LUN
    printf,lunw,'<html>'
    printf,lunw,'<head>'
    printf,lunw,'<TITLE>MNLupus - observed radial velocities</TITLE>'
    printf,lunw,'</head>'
    printf,lunw,'<body text="#00FFC8" link="#00FFFF" alink="#000096" vlink="#FFFF96" bgcolor="#000000">'
    printf,lunw,'<center>'
    printf,lunw,'<h1>MNLupus: observed radial velocities of the emission features</h1><br>'
